...
<h1 class="perso-titre" style="color: #50E2C1;
      font-size: 3.2rem; text-align: center; padding-top:30px">Personnalisation</h1>
  ...
  <div class="modalLogin">
    ...
    <form action="do_addComment.php" class="add" method="post">
      <div class="add-container">
          <textarea placeholder="Ajoutez un commentaire" name="comment" style="border: none;width: 900px;border-bottom: 1px grey solid;outline: none;font-family: 'Copperplate'"></textarea>
